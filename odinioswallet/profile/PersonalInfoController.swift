...
class PersonalInfoController: UIViewController ,UINavigationBarDelegate{
    ...
    var myTableViewController : PersonalFormTableView!
    override func viewDidLoad() {
        super.viewDidLoad()
       
        myTableViewController = self.childViewControllers[0] as! PersonalFormTableView
