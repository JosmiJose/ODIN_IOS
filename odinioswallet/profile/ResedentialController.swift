...
class ResedentialController: UIViewController ,UINavigationBarDelegate{
  var myTableViewController : ResedentialFormTableView!
    ...
    override func viewDidLoad() {
        ...
        myTableViewController = self.childViewControllers[0] as! ResedentialFormTableView
