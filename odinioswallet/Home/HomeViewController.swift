...
class HomeViewController: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let portChild : PortfolioViewController = (storyboard.instantiateViewController(withIdentifier: "Portfolio")) as! PortfolioViewController
      
        
        let exChild : ExchangeViewController = (storyboard.instantiateViewController(withIdentifier: "Exchange")) as! ExchangeViewController
      
        
        return [portChild,exChild]
    }
